...
class Triangle(val a: Double, val b: Double, val c: Double) : Shape(), Drawable {
    init {
        ...
        require(a + b > c && b + c > a && c + a > b) { "The sum of any two sides must be greater than the third side" }
    }
    ...
    override fun getBoundingBox(): Pair<Double, Double> {
        // This is an approximation. Accurate bounding box would require more information about the triangle's orientation.
        val s = (a + b + c) / 2
